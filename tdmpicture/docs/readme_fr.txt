...
- Ecraser le dossier TDMPicture, mettre jour le module depuis l'administration du site.
...
- Uploader tout le dossier 'TDMPicture' dans le dossier RACINE_DE_VOTRE_SITE/modules/
