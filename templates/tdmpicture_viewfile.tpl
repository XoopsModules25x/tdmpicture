        ...
        <{foreach item=file from=$file}>
            ...
            <div class="even outer">
                ...
                <div style="float:right; width:40%; margin:20px; display:inline-block;">
                    ...
                    <div id="tdmpicture_num" class="switch_info odd">
                        <{if $perm_vote}>
                            <a id="tdmpicture_voteup" href="javascript:;" onclick="AddVote(<{$file.id}>);return false;"
                        ...
                        <{if $perm_vote}>
                            <a id="tdmpicture_votedown" href="javascript:;"
                               ...
                               title="<{$smarty.const._MD_TDMPICTURE_VOTEREMOVE}>"></a>
                        <{/if}>
                    ...
                    <{if $file.menu}>
                        <div class="switch_large odd">
                            <{if $file.edit}>
                                <a href="<{$smarty.const.TDMPICTURE_URL}>/modfile.php?op=edit&file_id=<{$file.id}>"><img
                                            src="<{xoModuleIcons16 edit.png}>"></a>
                            <{/if}>
                            <{if $file.del}>
                                <a href="<{$smarty.const.TDMPICTURE_URL}>/modfile.php?op=delete&file_id=<{$file.id}>"><img
                                            src="<{xoModuleIcons16 delete.png}>"></a>
                            <{/if}>
                        </div>
                    <{/if}>
