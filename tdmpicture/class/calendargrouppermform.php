 ...
 * @version         $Id: calendargrouppermform.php 11977 2013-08-25 20:43:23Z beckmi $
 */
 ...
 * @access 		public
 */
class CalendarGroupPermForm extends XoopsForm
{
    /**
     * Module ID
     *
     ...
     * Constructor
     */
    function CalendarGroupPermForm($title, $modid, $permname, $permdesc, $url = '', $anonymous = true)
    {
     ...
     * @access public
     */
    function addItem($itemId, $itemName, $itemParent = 0, $anonymous = false)
    {
		...
		$this->_itemTree[$itemId]['anonymous'] = $anonymous;
    }
    ...
    function render()
    {
        ...
        foreach(array_keys($glist) as $i) {
            ...
            $ele = new CalendarGroupFormCheckBox($glist[$i], 'perms[' . $this->_permName . ']', $i, $selected);
 ...
 * @subpackage form
 */
class CalendarGroupFormCheckBox extends XoopsFormElement
{
    /**
     ...
     * Constructor
     */
    function CalendarGroupFormCheckBox($caption, $name, $groupId, $values = null)
    {
