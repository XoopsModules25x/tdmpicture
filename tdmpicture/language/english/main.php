...
//define("_MD_TDMPICTURE_ERROR","Error");
//define("_MD_TDMPICTURE_OK","OK");
//define("_MD_TDMPICTURE_ACTION","Action");
define("_MD_TDMPICTURE_IMG","Image");
//define("_MD_TDMPICTURE_MODIFY","Edit");
//define("_MD_TDMPICTURE_DELETE","Delete");
//define("_MD_TDMPICTURE_UPDATE","Updating without verification");
define("_MD_TDMPICTURE_ADD","Add");
define("_MD_TDMPICTURE_EDIT","Edit");
define("_MD_TDMPICTURE_PARENT","Parent");
//define("_MD_TDMPICTURE_PARENTDESC","Artist <br /> - <br /> Album 1 - Album 2");
define("_MD_TDMPICTURE_TEXT","Description");
define("_MD_TDMPICTURE_PATH","in this file %s");
define("_MD_TDMPICTURE_WEIGHT","weight");
...
define("_MD_TDMPICTURE_WIDTH","Width");
define("_MD_TDMPICTURE_HEIGHT","Height");
//
//define("_MD_TDMPICTURE_EDITOR","Publisher");
//define("_MD_TDMPICTURE_EDITORURL","URL Publisher");

//define("_MD_TDMPICTURE_WIKI","URL WikiPédia");

//define("_MD_TDMPICTURE_COLOR","Color");
//define("_MD_TDMPICTURE_GENRE","type");
//define("_MD_TDMPICTURE_ARTISTE","Artist");
//define("_MD_TDMPICTURE_ALBUM","Album");
//define("_MD_TDMPICTURE_CAT","Category");
define("_MD_TDMPICTURE_DISPLAYUSER","Show in the user");
...
define("_MD_TDMPICTURE_UPLOAD_LIMIT","Your proposal will be subject to validation of the host site.");
define("_MD_TDMPICTURE_NEWTHUMB","A new thumbnail will be created automatically.");
define("_MD_TDMPICTURE_RECAD","Zone Selection");
//define("_MD_TDMPICTURE_FORMSUREDEL","Are you sure you want to delete: NEWS <span style='color: Red'>% s </ span> </ b>");
define("_MD_TDMPICTURE_THEREAREALBUM","There are% s album (s)");
define("_MD_TDMPICTURE_RSS","RSS");

// Version 1.5
define("_MD_TDMPICTURE_MULTIUPLOAD","You can load %s file(s).");
define("_MD_TDMPICTURE_BY","By");
define("_MD_TDMPICTURE_IN","In");
//define("_MD_TDMPICTURE_FOR","To");
//define("_MD_TDMPICTURE_ANTI","Counter");
define('_MD_TDMPICTURE_PERM_2','Permissions to display');
define("_MD_TDMPICTURE_DISPLAYINDEX","Primary Category");
define("_MD_TDMPICTURE_DISPLAYINDEXDESC","Show all in album");
define("_MD_TDMPICTURE_NBFILE","# of Pictures");
define("_MD_TDMPICTURE_MEGABYTES"," MB");
define("_MD_TDMPICTURE_KILOBYTES"," KB");
define("_MD_TDMPICTURE_ADMIN"," Admin");
//version  1.07
define("_MD_TDMPICTURE_POPULAR","Popular");
define("_MD_TDMPICTURE_FULLSCREEN","Full Screen");
define("_MD_TDMPICTURE_LINK","Link");
define("_MD_TDMPICTURE_LINKFULLSCREEN","Link, Full Screen");
define("_MD_TDMPICTURE_LINKDHUMB","Link to Thumbnails");
define("_MD_TDMPICTURE_LINKFORUM","Link to Forum, Thumbnails");
define("_MD_TDMPICTURE_LINKFORUM1","Link to Forum 1, Thumbnails");
define("_MD_TDMPICTURE_LINKHTML","Link HTML, Thumbnails");

define("_MD_TDMPICTURE_UPLOADCAT","Upload Album");
define("_MD_TDMPICTURE_RESIZE","Resize image");

define("_MD_TDMPICTURE_FORMSUREDEL","Are you sure to delete it?");

define("_MD_TDMPICTURE_ASC","Ascending");
define("_MD_TDMPICTURE_DESC","Descending");
