    ...
    <table class="outer">
        ...
        <{foreach item=blocks from=$block.blocks}>
            <tr class="<{cycle values="even,odd"}>">
                <td><a href="<{$smarty.const.TDMPICTURE_URL}>/viewfile.php?st=<{$blocks.id}>"><{$blocks.title}></a>
                ...
                <ul class="display">
                    <{foreach item=blocks from=$block.blocks}>
                        <li>
                            ...
                            <div id="tdmpicture_num" class="switch_info odd">
                                <{if $perm_vote}>
                                    <a id="tdmpicture_voteup" href="javascript:;"
                                       onclick="AddVote(<{$blocks.id}>);return false;"
...
<{if $block.block_style == 4}>
    ...
    <div style="float:right;">
        <{$block.block_url}> | <a
                href="<{$smarty.const.TDMPICTURE_URL}>/index.php"><{$smarty.const._AM_TDMPICTURE_ALL}></a>
    </div>
<{/if}>
