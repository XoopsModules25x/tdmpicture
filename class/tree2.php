...
class TdmCatObjectTree extends XoopsObjectTree
{
     ...
     * @param        $ret2
     */
    public function _makeCatBoxOptions($itemHandler, $fieldName, $selected, $key, &$ret, &$ret2, $prefix_orig, $prefix_curr = '')
    {
     ...
     * @return string
     */
    public function makecatSelBox($name, $fieldName, $prefix = '-', $selected = '', $addEmptyOption = false, $key = 0, $extra = '', $perm = false)
    {
